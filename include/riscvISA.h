...
#define RISCV_AMO 0x2F

// funct3 or funct7
#define RISCV_PRIV 0x0
...
// funct5 (Atomic operations)
#define RISCV_AMO_ADDW 0x0
#define RISCV_AMO_SWAPW 0x1
#define RISCV_AMO_LRW 0x2
#define RISCV_AMO_SCW 0x3
#define RISCV_AMO_XORW 0x4
#define RISCV_AMO_ORW 0x8
#define RISCV_AMO_ANDW 0xC
#define RISCV_AMO_MINW 0x10
#define RISCV_AMO_MAXW 0x14
#define RISCV_AMO_MINWU 0x18
#define RISCV_AMO_MAXWU 0x1C
...
#define RISCV_SYSTEM_ENV_ECALL 0x000
#define RISCV_SYSTEM_ENV_EBREAK 0x001
#define RISCV_SYSTEM_ENV_MRET 0x302
#define RISCV_SYSTEM_ENV_WFI 0x105
...
/*
	SYSTEM CALL HANDLER
*/
#define SYS_context_switch 0
//#define SYS_irq_offload 1
//#define SYS_runtime_except 2
//#define SYS_system_call 3
#define SYS_exit 93
