...
#ifndef INCLUDE_CACHEMEMORY_MULTI_H_
#define INCLUDE_CACHEMEMORY_MULTI_H_
...
class CacheMemoryMulticore : public MemoryInterface<INTERFACE_SIZE> {
...
public:
  ...
  CacheMemoryMulticore(MulticoreMemory<INTERFACE_SIZE>* nextLevel, bool v)
  {
...
#endif /* INCLUDE_CACHEMEMORY_MULTI_H_ */
